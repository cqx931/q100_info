...
const renderCluster = function(input, w, h, type){
  ...
  const CONFIG_Energie = {width:w, height:h, colors:["grey","orange"], type: "Cluster", title: "Energieverbrauch", unit: "MWh"};
  const CONFIG_CO2 = {width:w, height:h, colors:["grey","orange"], type: "Cluster", title: "CO2" , unit: "tCO2"};
...
const renderTotal = function(input, w, h, type){
  ...
  let renderChart = horizontalBarChart;
  if (type == "vertical") renderChart = barChart;
  const CONFIG_Energie = {width:w, height:h, colors:["grey","orange"], type: "Total", title: "Energieverbrauch", unit: "MWh"};
  const CONFIG_CO2 = {width:w, height:h, colors:["grey","orange"], type: "Total", title: "CO2" , unit: "tCO2"};
